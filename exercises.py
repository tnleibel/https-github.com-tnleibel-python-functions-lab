...
def home_town_info():
    ...
    city = home_town.get('city')
    state = home_town.get('state')
    population = home_town.get('population')

    home_town_message = f'I was born in {city}, {state} - population of {population}'
    return home_town_message

# Call the function and print the result
print('Exercise 4:', home_town_info())
